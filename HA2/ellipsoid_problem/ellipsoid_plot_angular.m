function [vec, eig_vals] = ellipsoid_plot_angular(S,theta,endpt)

% get space-based jacobian 
J_s = J_space(S,theta);
% get the angular velocity values from the Jacobian 
J = J_s(1:3,:);
...
s = surf(X,Y,Z);
alpha(0.5)
title('Manipulability Ellipsoid: Angular Velocity')
axis equal
hold on 
